...
public class NetworkUtils {
    ...
    public static void openWirelessSettings(Context context) {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            context.startActivity(new Intent(android.provider.Settings.ACTION_WIFI_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            Log.d(TAG,String.format("isAvailableByPing errorMsg", result.errorMsg));
        }
        if (result.successMsg != null) {
            Log.d(TAG,String.format("isAvailableByPing successMsg", result.successMsg));
        }
        return ret;
    }
